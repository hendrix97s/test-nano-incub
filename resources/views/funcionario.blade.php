      ...
      <div class="flex items-center justify-center flex-col gap-2 card shadow rounded-xl w-3/6 min-w-min p-5  relative">
        ...
        @endif
          ...
          <div class="form-group mb-3">
              ...
              <input type="number" step="any" name="saldo_atual" id="saldo" class="form-control block w-full px-3 py-1.5 text-base font-normal text-gray-700 bg-white bg-clip-padding border border-solid border-gray-300 rounded transition ease-in-out m-0 focus:text-gray-700 focus:bg-white focus:border-blue-600 focus:outline-none"  placeholder="Insira o saldo"
